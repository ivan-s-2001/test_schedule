...
export const DEFAULT_SHIFT_POOL: readonly ShiftTemplate[] = [
  ...
  template("11-00_21-00", "Переработка", "11:00", "21:00", "#4A86E8", "#FFFFFF", "Увеличенная смена; фактическое время указано в ячейке", 100),
  template("12-30_00-00", "Переработка", "12:30", "00:00", "#E5E7EB", "#111827", "Увеличенная смена; фактическое время указано в ячейке", 110),
  template("13-00_00-00", "Переработка", "13:00", "00:00", "#4A86E8", "#FFFFFF", "Увеличенная смена; фактическое время указано в ячейке", 120),
] as const;
